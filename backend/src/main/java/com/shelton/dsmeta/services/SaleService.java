...
public class SaleService {
	...
	public Page<Sale> findSales(String minDate, String maxDate, Pageable pageable) {
		...
		LocalDate today = LocalDate.ofInstant(Instant.now(), ZoneId.systemDefault());//Data de hoje, com o fusu horario do sistema
		
		LocalDate min = minDate.equals("") ? today.minusDays(365) : LocalDate.parse(minDate); // um ano atras
